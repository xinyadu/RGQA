...
class WIKIDataModule(pl.LightningDataModule):
    '''
    Dataset processing for WIKI. Load Train from ACE, dev/test from WikiEvent. Involves chunking for long documents.
    '''
    def __init__(self, args):
        ...
        self.MAX_CONTEXT_LENGTH=200
        self.MAX_TGT_LENGTH=72 # MAX_TGT_LENGTH=50 (best)
                ...
                for lidx, line in enumerate(reader):
                    ...
                    for i in range(len(ex['event_mentions'])):
                        ...
                        for role in ontology_dict[evt_type]['questions']:
                            ...
                            all_tuples_tokenized_train.append([context, tokenized_question, tokenized_ans, "_".join([ex['doc_id'], str(i)]), role])
